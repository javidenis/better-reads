...
Revision ID: 5ddb1550c2ab
Revises: 
Create Date: 2022-06-28 16:27:03.664408
...
def upgrade():
    ...
    if environment == "production":
        ...
        op.execute(f"ALTER TABLE readstatues SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE bookshelfbooks SET SCHEMA {SCHEMA};")
        op.execute(f"ALTER TABLE bookgenres SET SCHEMA {SCHEMA};")
